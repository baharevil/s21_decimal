...
Suite *equal_suite1(void) {
  ...
  tcase_add_test(tc_core, test_is_equal41);
  tcase_add_test(tc_core, test_is_equal42);
  tcase_add_test(tc_core, test_is_equal43);
  tcase_add_test(tc_core, test_is_equal44);
  tcase_add_test(tc_core, test_is_equal45);
  tcase_add_test(tc_core, test_is_equal46);
  tcase_add_test(tc_core, test_is_equal47);
  tcase_add_test(tc_core, test_is_equal48);
  tcase_add_test(tc_core, test_is_equal49);
  tcase_add_test(tc_core, test_is_equal50);
  tcase_add_test(tc_core, test_is_equal51);
  tcase_add_test(tc_core, test_is_equal52);
  tcase_add_test(tc_core, test_is_equal53);
  tcase_add_test(tc_core, test_is_equal54);
  tcase_add_test(tc_core, test_is_equal55); 
