...
START_TEST(test_from_decimal_to_int_fail_manual1) {
    ...
    ck_assert_int_eq(code, conv_false);
}
END_TEST
...
Suite *from_decimal_to_int_suite1(void) {
    ...
    s = suite_create("\x1b[1;33m-=S21_FROM_DECIMAL_TO_INT_1-\x1b[0m");
...
Suite *from_decimal_to_int_suite2(void) {
    ...
    s = suite_create("\x1b[1;33m-=S21_FROM_DECIMAL_TO_INT_2-\x1b[0m");
    tc_core = tcase_create("Core");
...
Suite *from_decimal_to_int_suite3(void) {
    ...
    s = suite_create("\x1b[1;33m-=S21_FROM_DECIMAL_TO_INT_3-\x1b[0m");
    tc_core = tcase_create("Core");
...
Suite *from_decimal_to_int_suite0(void) {
    ...
    s = suite_create("\x1b[1;33m-=S21_FROM_DECIMAL_TO_INT_0-\x1b[0m");
    tc_core = tcase_create("Core");
