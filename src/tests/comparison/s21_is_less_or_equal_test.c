...
START_TEST(test_less_or_equal_fail_manual1) {
...
START_TEST(test_less_or_equal_fail_manual2) {
...
START_TEST(test_less_or_equal_fail_manual3) {
...
START_TEST(test_less_or_equal_fail_manual4) {
  // степень 29 (показатель степени должен быть от 0 до 28)
...
START_TEST(test_less_or_equal_fail_manual5) {
...
START_TEST(test_less_or_equal_fail_manual6) {
...
START_TEST(test_less_or_equal_fail_manual7) {
...
START_TEST(test_less_or_equal_fail_manual8) {
...
START_TEST(test_less_or_equal_fail_manual9) {
  // Просто все единицы
  s21_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x140000}};
...
START_TEST(test_less_or_equal_fail_manual10) {
  // степень 154 (показатель степени должен быть от 0 до 28)
  // биты 0-15 не нули
  // биты 24-30 не нули
  s21_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x140000}};
...
START_TEST(test_less_or_equal_fail_manual11) {
  // степень 29 (показатель степени должен быть от 0 до 28)
  s21_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x140000}};
...
START_TEST(test_less_or_equal_fail_manual12) {
  // степень 29 (показатель степени должен быть от 0 до 28)
...
START_TEST(test_less_or_equal_fail_manual13) {
  // степень 28 (что корректно), но биты 0-15 не нули (младший бит)
  s21_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x140000}};
...
START_TEST(test_less_or_equal_fail_manual14) {
  // степень 28 (что корректно), но биты 0-15 не нули (старший бит)
  s21_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x140000}};
...
START_TEST(test_less_or_equal_fail_manual15) {
  // степень 28 (что корректно), но биты 24-30 не нули (младший бит)
  s21_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x140000}};
  s21_decimal decimal2 = {{-1, 0, 0, 0x11C0000}};
  int code = s21_is_less_or_equal(decimal1, decimal2);
...
START_TEST(test_less_or_equal_fail_manual16) {
  // степень 28 (что корректно), но биты 24-30 не нули (старший бит)
  s21_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x140000}};
  s21_decimal decimal2 = {{-1, 0, 0, 0x401C0000}};
  int code = s21_is_less_or_equal(decimal1, decimal2);
...
START_TEST(test_less_or_equal_fail_manual17) {
  // Просто все единицы
  s21_decimal decimal1 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x140000}};
  s21_decimal decimal2 = {{0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF}};
  int code = s21_is_less_or_equal(decimal1, decimal2);
...
START_TEST(test_less_or_equal_fail_manual18) {
  // степень 28 (что корректно), но биты 24-30 не нули (старший бит)
...
Suite *less_or_equal_suite0(void) {
  ...
  s = suite_create("\x1b[1;33m-=s21_is_less_or_equal_or_equal_0=-\x1b[0m");
  tc_core = tcase_create("Core");
  tcase_add_test(tc_core, test_less_or_equal_fail_manual1);
  tcase_add_test(tc_core, test_less_or_equal_fail_manual2);
  tcase_add_test(tc_core, test_less_or_equal_fail_manual3);
  tcase_add_test(tc_core, test_less_or_equal_fail_manual4);
  tcase_add_test(tc_core, test_less_or_equal_fail_manual5);
  tcase_add_test(tc_core, test_less_or_equal_fail_manual6);
  tcase_add_test(tc_core, test_less_or_equal_fail_manual7);
  tcase_add_test(tc_core, test_less_or_equal_fail_manual8);
  tcase_add_test(tc_core, test_less_or_equal_fail_manual9);
  tcase_add_test(tc_core, test_less_or_equal_fail_manual10);
  tcase_add_test(tc_core, test_less_or_equal_fail_manual11);
  tcase_add_test(tc_core, test_less_or_equal_fail_manual12);
  tcase_add_test(tc_core, test_less_or_equal_fail_manual13);
  tcase_add_test(tc_core, test_less_or_equal_fail_manual14);
  tcase_add_test(tc_core, test_less_or_equal_fail_manual15);
  tcase_add_test(tc_core, test_less_or_equal_fail_manual16);
  tcase_add_test(tc_core, test_less_or_equal_fail_manual17);
  tcase_add_test(tc_core, test_less_or_equal_fail_manual18);
...
Suite *less_or_equal_suite1(void) {
  ...
  s = suite_create("\x1b[1;33m-=s21_is_less_or_equal_or_equal_1=-\x1b[0m");
  tc_core = tcase_create("Core");
  ...
  tcase_add_test(tc_core, test_is_less_or_equal30);
  tcase_add_test(tc_core, test_is_less_or_equal31);
  tcase_add_test(tc_core, test_is_less_or_equal32);
  tcase_add_test(tc_core, test_is_less_or_equal33);
  tcase_add_test(tc_core, test_is_less_or_equal34);
  tcase_add_test(tc_core, test_is_less_or_equal35);
  tcase_add_test(tc_core, test_is_less_or_equal36);
  tcase_add_test(tc_core, test_is_less_or_equal37);
  tcase_add_test(tc_core, test_is_less_or_equal38);
  tcase_add_test(tc_core, test_is_less_or_equal39);
  tcase_add_test(tc_core, test_is_less_or_equal40);
  tcase_add_test(tc_core, test_is_less_or_equal41);
  tcase_add_test(tc_core, test_is_less_or_equal42);
  tcase_add_test(tc_core, test_is_less_or_equal43);
  tcase_add_test(tc_core, test_is_less_or_equal44);
  tcase_add_test(tc_core, test_is_less_or_equal45);
  tcase_add_test(tc_core, test_is_less_or_equal46);
  tcase_add_test(tc_core, test_is_less_or_equal47);
  tcase_add_test(tc_core, test_is_less_or_equal48);
  tcase_add_test(tc_core, test_is_less_or_equal49);
  tcase_add_test(tc_core, test_is_less_or_equal50);
  tcase_add_test(tc_core, test_is_less_or_equal51);
  tcase_add_test(tc_core, test_is_less_or_equal52);
  tcase_add_test(tc_core, test_is_less_or_equal53);
  tcase_add_test(tc_core, test_is_less_or_equal54);
  tcase_add_test(tc_core, test_is_less_or_equal55);
