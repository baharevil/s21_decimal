...
START_TEST(test_not_equal_fail_manual1) {
...
START_TEST(test_not_equal_fail_manual2) {
...
START_TEST(test_not_equal_fail_manual3) {
...
START_TEST(test_not_equal_fail_manual4) {
  // степень 29 (показатель степени должен быть от 0 до 28)
...
START_TEST(test_not_equal_fail_manual5) {
...
START_TEST(test_not_equal_fail_manual6) {
...
START_TEST(test_not_equal_fail_manual7) {
...
START_TEST(test_not_equal_fail_manual8) {
...
START_TEST(test_not_equal_fail_manual9) {
  // Просто все единицы
...
START_TEST(test_not_equal_fail_manual10) {
  // степень 154 (показатель степени должен быть от 0 до 28)
  // биты 0-15 не нули
  // биты 24-30 не нули
...
START_TEST(test_not_equal_fail_manual11) {
  // степень 29 (показатель степени должен быть от 0 до 28)
...
START_TEST(test_not_equal_fail_manual12) {
  // степень 29 (показатель степени должен быть от 0 до 28)
...
START_TEST(test_not_equal_fail_manual13) {
  // степень 28 (что корректно), но биты 0-15 не нули (младший бит)
...
START_TEST(test_not_equal_fail_manual14) {
  // степень 28 (что корректно), но биты 0-15 не нули (старший бит)
...
START_TEST(test_not_equal_fail_manual15) {
  // степень 28 (что корректно), но биты 24-30 не нули (младший бит)
...
START_TEST(test_not_equal_fail_manual16) {
  // степень 28 (что корректно), но биты 24-30 не нули (старший бит)
...
START_TEST(test_not_equal_fail_manual17) {
  // Просто все единицы
...
Suite *not_equal_suite0(void) {
  ...
  s = suite_create("\x1b[1;33m-=S21_IS_NOT_EQUAL_0=-\x1b[0m");
  tc_core = tcase_create("Core");
  tcase_add_test(tc_core, test_not_equal_fail_manual1);
  tcase_add_test(tc_core, test_not_equal_fail_manual2);
  tcase_add_test(tc_core, test_not_equal_fail_manual3);
  tcase_add_test(tc_core, test_not_equal_fail_manual4);
  tcase_add_test(tc_core, test_not_equal_fail_manual5);
  tcase_add_test(tc_core, test_not_equal_fail_manual6);
  tcase_add_test(tc_core, test_not_equal_fail_manual7);
  tcase_add_test(tc_core, test_not_equal_fail_manual8);
  tcase_add_test(tc_core, test_not_equal_fail_manual9);
  tcase_add_test(tc_core, test_not_equal_fail_manual10);
  tcase_add_test(tc_core, test_not_equal_fail_manual11);
  tcase_add_test(tc_core, test_not_equal_fail_manual12);
  tcase_add_test(tc_core, test_not_equal_fail_manual13);
  tcase_add_test(tc_core, test_not_equal_fail_manual14);
  tcase_add_test(tc_core, test_not_equal_fail_manual15);
  tcase_add_test(tc_core, test_not_equal_fail_manual16);
  tcase_add_test(tc_core, test_not_equal_fail_manual17);
...
Suite *not_equal_suite1(void) {
  ...
  s = suite_create("\x1b[1;33m-=S21_IS_NOT_EQUAL_1=-\x1b[0m");
  tc_core = tcase_create("Core");
  ...
  tcase_add_test(tc_core, test_is_not_equal41);
  tcase_add_test(tc_core, test_is_not_equal42);
  tcase_add_test(tc_core, test_is_not_equal43);
  tcase_add_test(tc_core, test_is_not_equal44);
  tcase_add_test(tc_core, test_is_not_equal45);
  tcase_add_test(tc_core, test_is_not_equal46);
  tcase_add_test(tc_core, test_is_not_equal47);
  tcase_add_test(tc_core, test_is_not_equal48);
  tcase_add_test(tc_core, test_is_not_equal49);
  tcase_add_test(tc_core, test_is_not_equal50);
  tcase_add_test(tc_core, test_is_not_equal51);
  tcase_add_test(tc_core, test_is_not_equal52);
  tcase_add_test(tc_core, test_is_not_equal53);
  tcase_add_test(tc_core, test_is_not_equal54);
  tcase_add_test(tc_core, test_is_not_equal55);
